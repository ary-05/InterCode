  ...
  return (
    <div className="h-screen bg-base-100 flex flex-col">
      ...
      <div className="flex-1 flex flex-col">
        <DesktopOnlyGate pageLabel="The live session" />
                    ...
                    <div className="p-6 bg-base-100 border-b border-base-300">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="flex items-center gap-3">
                          <span
                            className={`badge badge-lg font-nunito font-bold ${getDifficultyBadgeClass(
                              session?.difficulty
                            )}`}
                          >
                            {session?.difficulty
                          ...
                          {isHost && session?.status === "active" && (
                            <button
                              ...
                              className="btn btn-error btn-sm gap-2 font-nunito"
                            >
                          ...
                          {session?.status === "completed" && (
                            <span className="badge badge-ghost badge-lg font-nunito">Completed</span>
                          )}
                        </div>
                      </div>
                    </div>
